...
export default function Scene3() {
  ...
  return (
    <SceneWrapper>
      <div className="w-full h-full flex flex-row items-center justify-between gap-12 p-8 max-w-6xl mx-auto">
        ...
        <div className="flex-1 w-full text-left flex flex-col justify-center">
          <motion.div
            ...
            className="mb-8"
          >
            <h2 className="text-5xl font-black text-gray-800 uppercase tracking-wider" style={{ WebkitTextStroke: '1.5px #000' }}>
              {ideathonData.scene3.title}
            </h2>
            <h3 className="text-2xl font-bold text-blue-600 uppercase tracking-widest mt-2">
          ...
          >
            <p className="text-xl font-bold text-gray-700 mb-2">Your mission is simple:</p>
        ...
        <motion.div 
          ...
          className="flex-1 w-full flex justify-center items-center mt-0"
        >
